	...
	do{
		...
		switch(opc){
			case 1:
				...
				setbuf(stdin,NULL);
				gets(cli.cpf);
				printf("Escolha o plano do cliente:\n");
				setbuf(stdin,NULL);
                int tp;
                do{
					printf("1 - 10Mbps\n");
                	...
                	switch (tp){
                	case 1:
                		strcpy( cli.plano, "10Mbps"); 
                    	break;
                	case 2:
                		strcpy( cli.plano, "20Mbps"); 
                    	break;
                	case 3:
                		strcpy( cli.plano, "50Mbps"); 			
                		break;
                	case 4:
                		strcpy( cli.plano, "100Mbps"); 
                    	break;
                	default:
			...
			case 3:
				...
				if(check != -1){
					...
					setbuf(stdin,NULL);
					gets(cli.cpf);
					printf("Escolha a alteracao do plano do cliente:\n");
					setbuf(stdin,NULL);
                    int tp;
                    do{printf("1 - 10Mbps\n");
                    	printf("2 - 20Mbps\n");
			...
			case 6:
				system("cls");
        		printf("-------------------------------------------------------------\n");
	    		printf("|                RECUPERAR CLIENTES EM ARQUIVO              |\n");
	    		printf("-------------------------------------------------------------\n");
				Nodo *atual;
    			FILE *arq;
